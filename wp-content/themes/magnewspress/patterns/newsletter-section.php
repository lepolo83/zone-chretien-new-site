 ...
 * Slug: magnewspress/newsletter-section
        ...
        <div class="wp-block-cover__inner-container"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"left":"var:preset|spacing|80"}}}} -->
            <div class="wp-block-columns are-vertically-aligned-center"><!-- wp:column {"verticalAlignment":"center","width":"45%"} -->
                <div class="wp-block-column is-vertically-aligned-center" style="flex-basis:45%"><!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|light-color"}}}},"textColor":"light-color"} -->
                    <h2 class="wp-block-heading has-light-color-color has-text-color has-link-color"><?php esc_html_e('Subscribe to our Newsletter and Stay Updated.', 'magnewspress') ?></h2>
                    <!-- /wp:heading -->
                </div>
                <!-- /wp:column -->

                <!-- wp:column {"verticalAlignment":"center"} -->
                <div class="wp-block-column is-vertically-aligned-center"><!-- wp:contact-form-7/contact-form-selector {"id":1127,"hash":"de17a25","title":"Newsletter Form","className":"magnewspress-newsletter"} -->
                    <div class="wp-block-contact-form-7-contact-form-selector magnewspress-newsletter">[contact-form-7 id="de17a25" title="Newsletter Form"]</div>
