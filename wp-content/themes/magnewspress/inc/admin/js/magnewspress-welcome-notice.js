(function ($) {
  ...
  $("#install-activate-button").on("click", function (e) {
    ...
    var activationData = {
      action: "magnewspress_install_and_activate_plugins",
      nonce: magnewspress_localize.nonce,
    };
    $.post(magnewspress_localize.ajax_url, activationData, function (response) {
      ...
      if (match) {
        ...
        try {
          ...
          if (responseObj.success === true) {
            window.location.href = magnewspress_localize.redirect_url;
          } else {
            console.log("Error!");
          }
        } catch (error) {
